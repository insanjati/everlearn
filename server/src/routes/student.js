...
router.get('/:studentId/profile', authStudent, studentController.getProfile);
router.put('/:studentId/profile', authStudent, studentController.putProfile);

router.get('/:studentId/purchase', authStudent, studentController.getPurchases);
router.put('/:studentId/purchase', authStudent, studentController.postPurchases); // is it okay untuk bisa purchase item yang sama berkali2 ?
